...
const MANIFEST = {
  ...
  user_config: {
    GOVTOOLSPRO_API_KEY: {
      ...
      description:
        "API key minted from the GovToolsPro Chrome extension → Profile → API Keys tab. Format: gtp_live_... or gtp_test_...",
      sensitive: true,
      required: true,
    },
